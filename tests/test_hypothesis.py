...
#     @given(
#         log_hazard=st.lists(
#             st.floats(min_value=-1000, max_value=1000), min_size=1, max_size=100
#         ),
#         n_samples=st.integers(min_value=10, max_value=100),
#     )
#     def test_cox_loss_properties(log_hazard, n_samples) -> None:
...
#             log_hazard_tensor, survival_times, event_indicators
#         )
