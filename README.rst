...
.. image:: https://img.shields.io/pypi/pyversions/torchsurv?label=Python
   :target: https://pypi.org/project/torchsurv/
   :alt: Python

.. image:: https://img.shields.io/pypi/v/torchsurv?color=green&label=PyPI
   :target: https://pypi.org/project/torchsurv/
   :alt: PyPI - Version

.. image:: https://img.shields.io/conda/v/conda-forge/torchsurv?label=Conda&color=green
   :target: https://anaconda.org/conda-forge/torchsurv
   :alt: Conda

.. image:: https://img.shields.io/pypi/dm/torchsurv.svg?label=PyPI%20downloads
   :target: https://pypi.org/project/torchsurv/
   :alt: PyPI Downloads

.. image:: https://img.shields.io/conda/dn/conda-forge/torchsurv.svg?label=Conda%20downloads
   :target: https://anaconda.org/conda-forge/torchsurv
   :alt: Conda Downloads

.. image:: https://github.com/Novartis/torchsurv/actions/workflows/codeqc.yml/badge.svg?branch=main
   :target: https://github.com/Novartis/torchsurv/actions/workflows/codeqc.yml
   :alt: CodeQC

.. image:: https://github.com/Novartis/torchsurv/actions/workflows/docs.yml/badge.svg?branch=main
   :target: https://github.com/Novartis/torchsurv/actions/workflows/docs.yml
   :alt: Docs

.. image:: https://www.codefactor.io/repository/github/novartis/torchsurv/badge/main
   :target: https://www.codefactor.io/repository/github/novartis/torchsurv/overview/main
   :alt: CodeFactor

.. image:: https://joss.theoj.org/papers/02d7496da2b9cc34f9a6e04cabf2298d/status.svg
   :target: https://joss.theoj.org/papers/02d7496da2b9cc34f9a6e04cabf2298d
   :alt: JOSS
...
.. image:: https://img.shields.io/badge/GithubPage-Sphinx-blue
   :target: https://opensource.nibr.com/torchsurv/
   :alt: Documentation
...
This package was developed by **Novartis** and the **US Food and Drug Administration (FDA)** as part of a **research collaboration** agreement on `radiogenomics <https://www.medrxiv.org/content/10.1101/2023.08.30.23294367v1.full.pdf>`_.
...
First, install the package using either `PyPI <https://pypi.org/project/torchsurv/>`_ or `Conda <https://anaconda.org/conda-forge/torchsurv>`_
...
Additionally, to build the documentation (``notebooks``, ``sphinx``) and for package development (``tests``), please see `the development notes <https://opensource.nibr.com/torchsurv/devnotes.html>`_ and `dev/environment.yml <dev/environment.yml>`_. This step is **not required** to use ``TorchSurv`` in your projects but only for optional features.
...
We recommend starting with the `introductory guide <https://opensource.nibr.com/torchsurv/notebooks/introduction.html>`_, where you'll find an overview of the package's functionalities.
...
The table below compares the functionalities of ``TorchSurv`` with those of `auton-survival <https://proceedings.mlr.press/v182/nagpal22a.html>`_, `pycox <http://jmlr.org/papers/v20/18-424.html>`_, `torchlife <https://sachinruk.github.io/torchlife//index.html>`_, `scikit-survival <https://jmlr.org/papers/v21/20-729.html>`_, `lifelines <https://joss.theoj.org/papers/10.21105/joss.01317>`_, and `deepsurv <https://bmcmedresmethodol.biomedcentral.com/articles/10.1186/s12874-018-0482-1>`_. While several libraries offer survival modelling functionalities, no existing library provides the flexibility to use a custom PyTorch-based neural networks to define the survival model parameters.

The outputs of both the log-likelihood functions and the evaluation metrics functions have **undergone thorough comparison with benchmarks generated** using ``Python`` and ``R`` packages. The comparisons (at time of publication) are summarised in the `Related packages summary <https://opensource.nibr.com/torchsurv/benchmarks.html>`_.

.. image:: /docs/_static/table_python_benchmark.png
   :alt: Survival analysis libraries in Python

.. image:: /docs/_static/table_python_benchmark_legend.png
   :alt: Survival analysis libraries in Python
...
.. image:: /docs/_static/table_r_benchmark.png
   :alt: Survival analysis libraries in R

Contributing
============

``TorchSurv`` is deeply rooted in open source and multi-institution collaboration. We always welcome help to implement new features (or fix bugs!).

Interested? Check out our `guidelines <CONTRIBUTING.md>`_!

Maintainers
===========

Get in touch with our `maintainers <CODEOWNERS.md>`_.
